        ...
        If cboCodeSet.SelectedIndex <> -1 AndAlso cboDeviceType.SelectedIndex <> -1 Then
            ...
            For i As Integer = 0 To cboCommand.Items.Count - 1
                ...
                If Not SelectedModule Is Nothing Then
                    moduleString = "M" & SelectedModule("ModuleNumber") & "|"
                End If
                newCommand.Value = BuildCFLinkCommandRAW(SelectedDevice("CFLinkID"), "TIRXSND", moduleString & "P" & cboIRPort.SelectedItem.ToString & ":DBA:" & theDB.GetDeviceType(cboDeviceType.Text).DeviceNumber.ToString.PadLeft(2, "0") & ":" & cboCodeSet.Text.PadLeft(4, "0") & ":" & (i + 1).ToString.PadLeft(2, "0"))
